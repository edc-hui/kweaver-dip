...
import { AgentDetailType, AgentVersion } from '@decision-agent/apis/agent-factory/type';
import { formatTimeSlash } from '@decision-agent/utils/handle-function/FormatTime';
import styles from './index.module.less';
import GradientContainer from '../GradientContainer';
import { defaultTempZoneConfig } from '@decision-agent/components/AgentConfig/ConfigSection/InputConfig/constants';
import FileSettingsModal from '@decision-agent/components/AgentConfig/ConfigSection/FileSettingsModal';
import ModelSettingsPopover from '@decision-agent/components/AgentConfig/ConfigSection/ModelSettingsPopover';
import SkillsSection from '@decision-agent/components/AgentConfig/ConfigSection/sections/SkillsSection';
import { hiddenBuildInFields } from '@decision-agent/components/AgentConfig/ConfigSection/utils';
