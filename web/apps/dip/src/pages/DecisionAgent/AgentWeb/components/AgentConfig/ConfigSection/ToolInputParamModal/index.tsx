...
import ADTable from '@decision-agent/components/ADTable';
import classNames from 'classnames';
import ErrorTip from '@decision-agent/components/ErrorTip';
import { getAgentDetailInUsagePage, type ResultProcessStrategyType } from '@decision-agent/apis/agent-factory';
import { getInputParamsFromOpenAPISpec } from '../utils';
import _ from 'lodash';
import './style.less';
import ParamMapSelect from './ParamMapSelect';
import { adTreeUtils } from '@decision-agent/utils/handle-function';
import LoadingMask from '@decision-agent/components/LoadingMask';
import { QuestionCircleFilled } from '@ant-design/icons';
import { useLatestState, useBusinessDomain } from '@decision-agent/hooks';
import { getToolById } from '@decision-agent/apis/agent-operator-integration';
      ...
      render: (value: string, record: any) => {
        ...
        return (
          <ErrorTip
            ...
            getPopupContainer={() => document.querySelector('.ToolParamTable .dip-table-body > table')}
          >
            <ParamMapSelect
              readonly={readonly}
