...
import UploadTooltipImage from '@decision-agent/assets/icons/upload-sample.svg?react';
import UploadTooltipImageTW from '@decision-agent/assets/icons/upload-sample-tw.svg?react';
import UploadTooltipImageUS from '@decision-agent/assets/icons/upload-sample-us.svg?react';
import TempZoneTooltipImage from '@decision-agent/assets/icons/temp-zone-sample.svg?react';
import TempZoneTiiltipImageTW from '@decision-agent/assets/icons/temp-zone-sample-tw.svg?react';
import TempZoneTiiltipImageUS from '@decision-agent/assets/icons/temp-zone-sample-us.svg?react';
