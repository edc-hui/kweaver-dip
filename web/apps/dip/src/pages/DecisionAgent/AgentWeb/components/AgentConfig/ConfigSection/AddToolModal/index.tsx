...
import AdTree from '@decision-agent/components/AdTree';
import LoadingMask from '@decision-agent/components/LoadingMask';
import AdTab from '@decision-agent/components/AdTab';
import LoadFailed from '@decision-agent/components/LoadFailed';
import UniversalModal from '@decision-agent/components/UniversalModal';
import { type AdTreeDataNode, adTreeUtils } from '@decision-agent/utils/handle-function';
import { getToolBoxListFromMarks, getBoxToolList, getGlobalMarketToolList } from '@decision-agent/apis/agent-operator-integration';
import {
  getMCPServerList,
  getMCPServerTools,
  type MCPServerReleaseInfo,
  type MCPTool,
} from '@decision-agent/apis/agent-operator-integration/mcp';
import { useMicroWidgetProps, useBusinessDomain } from '@decision-agent/hooks';
import { getModelList as getModelListReq } from '@decision-agent/apis/model-manager';
import {
...
import { DatasourceConfigTypeEnum, LLMConfigTypeEnum } from '@decision-agent/apis/agent-factory/type';
import { useLatestState } from '@decision-agent/hooks';
import AgentIcon from '@decision-agent/assets/icons/agent3.svg?react';
import ToolBoxIcon from '@decision-agent/assets/images/tool.svg?react';
import ToolIcon from '@decision-agent/assets/icons/tool.svg?react';
import MCPIcon from '@decision-agent/assets/icons/mcp.svg?react';
import NoResultIcon from '@decision-agent/assets/icons/no-result.svg?react';
import {
