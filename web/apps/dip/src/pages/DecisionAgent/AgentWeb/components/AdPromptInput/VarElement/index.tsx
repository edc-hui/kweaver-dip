...
import { getVarTextFromPromptVar } from '@decision-agent/components/AdPromptInput/assitant';
import type { VarOptions } from '@decision-agent/components/AdPromptInput/interface.ts';
