...
import { DipChatItemContentType } from '@decision-agent/components/DipChat/interface';
...
const NetSearchList = ({ citesList }: any) => {
  ...
  const cites = Array.isArray(citesList) ? citesList : Array.isArray(activeContent?.cites) ? activeContent.cites : [];
