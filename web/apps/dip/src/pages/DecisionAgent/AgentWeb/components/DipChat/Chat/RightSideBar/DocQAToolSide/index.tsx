...
import NoData from '@decision-agent/components/NoData';
...
const DocQAToolSide = ({ onPreview }: any) => {
  ...
  const cites = Array.isArray(activeProgress?.docQaToolResult?.cites) ? activeProgress.docQaToolResult.cites : [];
