...
import { VariableSizeGrid } from 'react-window-v1';
import AutoSizer from 'react-virtualized-auto-sizer';
import { getAgentsByPost } from '@decision-agent/apis/agent-factory';
import LoadFailedIcon from '@decision-agent/assets/icons/load-failed.svg?react';
...
import BaseCard, { rowHeight, loadingMoreRowHeight, gap } from '@decision-agent/components/BaseCard';
