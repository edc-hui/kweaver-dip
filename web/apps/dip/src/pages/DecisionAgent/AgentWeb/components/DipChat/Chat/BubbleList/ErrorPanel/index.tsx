                ...
                <Tooltip title="AI排查">
                  <Button
                    ...
                    onClick={() => {
                      ...
                      window.open(
                        `${microWidgetProps.history.getBasePath}/usage?id=${logQueryAgentDetails.id}&version=${logQueryAgentDetails.version}&agentAppType=common&state=${encodedState}&hidesidebar=true`
                      );
                    }}
                    type="text"
