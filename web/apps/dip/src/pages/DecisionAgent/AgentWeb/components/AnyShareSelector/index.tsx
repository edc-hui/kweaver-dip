...
import { FileTypeIcon } from '@decision-agent/utils/doc';
import { useMicroWidgetProps } from '@decision-agent/hooks';
import DataSource from '@decision-agent/assets/icons/data-source.svg?react';
import { getDocsSourceListByDsId } from '@decision-agent/apis/knowledge-data';
import { getDocsSourceList } from '@decision-agent/apis/data-connection';
import { getInFoByPath, getDirList } from '@decision-agent/apis/agent-factory';
import './style.less';
