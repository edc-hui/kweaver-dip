...
import RoleInstructionIcon from '@decision-agent/assets/icons/role-instruction.svg?react';
import AiIcon from '@decision-agent/assets/icons/ai-generate.svg?react';
import OutputIcon from '@decision-agent/assets/icons/output.svg?react';
import AdPromptInput from '@decision-agent/components/AdPromptInput';
import Format from '@decision-agent/components/Format';
import IconFont from '@decision-agent/components/IconFont';
import { useDeepCompareEffect, useMicroWidgetProps, useBusinessDomain } from '@decision-agent/hooks';
import { getAgentsByPost } from '@decision-agent/apis/agent-factory';
import { getToolBoxMarketList, getBoxToolList } from '@decision-agent/apis/agent-operator-integration';
import { getMCPServerDetail } from '@decision-agent/apis/agent-operator-integration/mcp';
