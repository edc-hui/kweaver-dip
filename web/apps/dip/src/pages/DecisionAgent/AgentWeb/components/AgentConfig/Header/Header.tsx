...
import { useSearchParams, useNavigate, useBlocker, useLocation } from 'react-router-dom';
import classNames from 'classnames';
import intl from 'react-intl-universal';
import { LeftOutlined } from '@ant-design/icons';
import { Button, Modal } from 'antd';
import { useMicroWidgetProps, useNavigationBlocker } from '@decision-agent/hooks';
  ...
  const redirect = () => {
    ...
    if (redirectUrl) {
      ...
      if (mode === 'createAgent' && !!templateId) {
        ...
        navigate(
          filterParams
            ? `${getDecisionAgentBasePath(location.pathname)}?filterParams=${filterParams}`
            : getDecisionAgentBasePath(location.pathname)
        );
      }
    }
  };
