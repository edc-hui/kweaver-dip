...
const IconFontBase = createFromIconfontCN({
  scriptUrl: [
    /* eslint-disable */
    require('@decision-agent/assets/fonts/lineIconfont.js'), // 线条风格icon
    require('@decision-agent/assets/fonts/colorIconfont.js'), // 彩色风格icon
    require('@decision-agent/assets/graphIcons/iconfont.js'), // 图谱icon
    require('@decision-agent/assets/fonts/twotoneIconfont.js'), // 双色icon
    require('@decision-agent/assets/fonts/menuIconfont.js'), // 菜单icon
    /* eslint-enable */
  ],
});
