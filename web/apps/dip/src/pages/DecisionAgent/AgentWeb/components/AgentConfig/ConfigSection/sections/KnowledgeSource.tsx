...
import KnEntryIcon from '@decision-agent/assets/icons/kn-entry.svg?react';
import NetworkIcon from '@decision-agent/assets/icons/network.svg?react';
import KnowledgeIcon from '@decision-agent/assets/icons/knowledge.svg?react';
import { getMetricInfoByIds, getDataDictInfoByIds } from '@decision-agent/apis/data-model';
import { getKnExperimentDetailsById } from '@decision-agent/apis/knowledge-data';
import { useAgentConfig } from '../../AgentConfigContext';
import KnEntrySelector from '@decision-agent/components/KnEntrySelector';
import DipIcon from '@decision-agent/components/DipIcon';
import MetricSelector from '@decision-agent/components/MetricSelector';
import SectionPanel from '../../common/SectionPanel';
import styles from '../ConfigSection.module.less';
import KnowledgeNetworkExperimentalSelect from '@decision-agent/components/KnowledgeNetworkExperimentalSelect';
import { useDeepCompareEffect } from '@decision-agent/hooks';
