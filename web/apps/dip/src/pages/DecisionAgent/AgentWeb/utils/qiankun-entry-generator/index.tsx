...
import { MicroWidgetContext } from '@decision-agent/hooks/useMicroWidgetProps';
import { setConfig } from '@decision-agent/utils/http';
import { initializeI18n } from '@decision-agent/i18n';
...
import '@decision-agent/assets/graphIconsMore/iconfont.css';
