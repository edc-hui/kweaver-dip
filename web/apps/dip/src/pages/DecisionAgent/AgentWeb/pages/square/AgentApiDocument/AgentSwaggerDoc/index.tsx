...
import { getCommonHttpHeaders } from '@decision-agent/utils/http';

import _ from 'lodash';
import { getComponentEventEmitter, ComponentIDEnum } from '@decision-agent/utils/event-bus';
...
const AdSwaggerDoc = (props: AdSwaggerDocPros) => {
  ...
  useEffect(() => {
    ...
    if (_.isEmpty(newData) || !apiBasePath) {
      setApiData({});
      return;
    }
